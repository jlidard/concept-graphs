...
SAVE_PCD_RESULT_PATH=$ZED_ROOT/$SCENE_NAME/partial_pcd.ply
FULL_PCD_PATH=$ZED_ROOT/$SCENE_NAME/ptcloud/ptcloud.ply

python launch/generate_vertices.py \
--result_path $RESULT_PATH \
--json_file ${ZED_ROOT}/${SCENE_NAME}/sg_cache/captions.json \
--save_file ${SAVE_PATH} \
